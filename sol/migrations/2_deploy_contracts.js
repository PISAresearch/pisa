...
module.exports = function(deployer, network, accounts) {
  ...
  deployer.deploy(DataRegistry).then(function() { return deployer.deploy(MultiChannelContract, DataRegistry.address); }).then(function() {return deployer.deploy(PisaHash, DataRegistry.address, 2, 300, accounts[0],  [accounts[5],accounts[6],accounts[7],accounts[8],accounts[9]], 2)});
